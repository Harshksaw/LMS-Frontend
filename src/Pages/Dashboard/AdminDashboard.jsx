          ...
          <div className="grid grid-cols-2 gap-5 m-auto mx-10 ">
              ...
              <div className="grid grid-cols-2 gap-5  ">
                <div className="flex  items-center gap-5 rounded-md p-5  justify-between  shadow-[0_0_5px_blue]">
                  ...
                  <div className="flex flex-col items-center gap-3">
                    <p className=" font-semibold text-green-300">Enrolled User</p>
            ...
            <div className="flex flex-col items-center gap-10 p-5 shadow-lg rounded-md">
              ...
              <div className="grid gird-cols-2 gap-5">
                ...
                <div className="flex flex-col items-center ">
                  <p className=" font-semibold text-pink-600">Total revenue</p>
                ...
                {/* {myCourse?.map((course, idx) => {
                  return (
                    <tr key={course._id}>
                      ...
                      <td>
                        <button
                          className="bg-green-500 p-2 shadow-md  w-fit hover:bg-green-900 transition-all ease-in-out duration-300 rounded py-2 font-semibold text-lg  px-4 cursor-pointer "
                          onClick={() =>
                        ...
                        <button
                          className="bg-red-500 p-2 shadow-md  w-fit hover:bg-red-800 transition-all ease-in-out duration-300 rounded py-2 font-semibold text-lg  px-4 cursor-pointer "
