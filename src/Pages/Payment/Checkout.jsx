                ...
                <div className = "w-80 h-[26rem] flex flex-col justify-center shadow-[0_0{10px_black] rounded-lg relative">
                    ...
                    <div className= 'px-4 space-y-5 text-center '>
                        <p className="text-[17px]">
                            ...
                            <button type='submit' className='bg-green-500 transition-all ease-in-out duration-300 absolute bottom-0 w-full left-0 text-xl font-bold rounded-br-lg rounded-bl-lg'>
